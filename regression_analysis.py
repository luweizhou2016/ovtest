...
for stream_idx in range(0, len(target_stream_list)):
    ...
    # for stream in perf_from_file(target_path):
    #     target_perf, target_avg = stream
    #     print(target_perf)
    #     print('-----------------------------------------------------')

    # for stream in perf_from_file(ref_path):
    #     ref_perf, ref_avg = stream
    #     print(ref_perf)
    #     print('#######################################################')
